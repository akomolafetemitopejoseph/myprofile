  ...
  return (
    <div>
      <div id="porfolio">
        ...
        >
          <img className="w-[100%] h-fit m-auto " src={img} alt="" />
          <div className="w-full space-y-5 bg-gray-700  p-5">
            ...
            <p className="items-center gap-2 mt-5 text-blue-500 hover:text-blue-200 font-bold text-xl max-sm:text-2xl capitalize cursor-pointer transition-all duration-700">
