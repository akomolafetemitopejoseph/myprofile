...
const TextimonialProps = () => {
  return (
    <div>
      <h1 className="bg-gray-900 text-center text-4xl p-10 font-bold text-white">See why they love my work</h1>
      <div className="bg-gray-900 grid grid-cols-2 p-15 gap-5">
        <Testimonails
