...
const Ratings = () => {
  return (
    <div className="bg-gray-900">
      ...
      <div className="flex justify-center max-sm:grid p-15 max-sm:p-5">

        <div className="flex max-sm:grid p-5 items-center max-sm:text-center gap-5 w-[240px] max-sm:w-[100%]">
        ...
        <div className="flex max-sm:grid p-5 items-center gap-5 w-[240px] max-sm:w-[100%] max-sm:text-center">
          <h1 className="text-7xl text-white "><CountUp end={2} duration={2} delay={1}/></h1>
