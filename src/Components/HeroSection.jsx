...
const HeroSection = () => {
  return (
    <div className="bg-[#111827] h-screen max-sm:p-5">
      
      <div className="items-center mt-15 pt-15 max-sm:pt-5 text-center">
        <div>
          <img
            className="w-[200px] h-[200px] rounded-[50%] border-4 border-gray-600 mx-auto"
            src={myimage}
            alt="imagee"
          />
        </div>
        ...
        <h1 className="leading-10 text-[1.2rem] max-sm:text-[2rem] font-semibold text-white">
          Fendend Developer
        </h1>

        <p className="mt-5 max-sm:mt-2 font-bold text-l max-sm:text-xl max-sm:p-5 text-white">
        ...
        <div class="flex  items-center justify-center mt-10 max-sm:mt-5 max-sm:p-5">
          <div class="group relative">
            ...
            <button class="relative flex items-center gap-4 rounded-lg bg-gray-900 cursor-pointer px-7 max-sm:px-3 py-4 max-sm:py-3  hover:text-gray-700 active:bg-gray-100 transition-all duration-700 font-bold text-white text-xl capitalize max-sm:text-sm">
