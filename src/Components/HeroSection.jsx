  ...
  return (
    <div className="bg-[#111827] h-screen max-sm:p-5">
      ...
      <div className="items-center mt-15 pt-15 max-sm:pt-5 text-center">
        ...
        <h1 className="leading-10 max-md:leading-8 text-[1.2rem] max-md:text-[1.4rem]  font-semibold text-white">
          Fendend Developer
        </h1>

        <p className="mt-5 max-md:mt-2 font-bold text-l max-md:text-l max-md:p-2 text-white">
        ...
        <div class="flex  items-center justify-center mt-10 max-sm:mt-5 max-sm:p-5">
          <div class="group relative">
            ...
            <button class="relative flex items-center gap-4 rounded-lg bg-gray-900 cursor-pointer px-7 max-md:px-2 py-4 max-md:py-3  hover:text-gray-700 active:bg-gray-100 transition-all duration-700 font-bold text-white text-xl capitalize max-md:text-sm">
