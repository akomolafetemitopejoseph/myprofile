  ...
  return (
    <div>
      ...
      <div className="bg-gray-800">
        <h1 className="text-center text-3xl max-sm:text-4xl font-extrabold text-white pt-10">
          Featured Projects
        </h1>
        <div className="grid max-sm:grid-cols-1 grid-cols-2 gap-5 m-15 max-sm:m-5">
          <Portfolio
            img={img1}
