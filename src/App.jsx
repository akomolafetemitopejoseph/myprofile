...
import design2 from "./assets/design.jpg";
import design3 from "./assets/design2.jpg"
import design4 from "./assets/design3.jpg"
  ...
  return (
    <div>
      ...
      <div className="bg-gray-800">
        ...
        <div className="grid grid-cols-2 justify-center gap-5 mt-10 justify-items-center">
          <Portfolio
            img={img1}
